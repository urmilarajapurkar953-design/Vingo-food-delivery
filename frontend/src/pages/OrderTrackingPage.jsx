...
import { FaArrowLeft, FaPhoneAlt, FaUser, FaStoreAlt, FaBox, FaMapMarkerAlt, FaMotorcycle, FaWallet, FaCreditCard } from 'react-icons/fa';
    ...
    <div className="max-w-6xl mx-auto p-4 md:p-6 min-h-screen bg-gray-50 mt-[50px]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
        <button 
          ...
          className="flex items-center gap-2 text-sm font-bold text-gray-600 hover:text-gray-900 bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-xl transition-colors cursor-pointer border-none outline-none w-fit"
        >
        ...
        <div className="flex items-center gap-3">
          <div className={`flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-black uppercase tracking-wider border ${
            ...
            {isCOD ? <FaWallet /> : <FaCreditCard />}
            Mode: {isCOD ? "Cash on Delivery" : "Online Secured Payment"}
          </div>
